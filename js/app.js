...
import {
  ...
  deleteColumn, archiveColumn, restoreColumn, deleteColumnPermanently, copyColumn, pasteColumn, duplicateColumn, pasteColumnToBoard, setColumnColor,
  createCard, saveCard, deleteCard, archiveCard,   restoreCard,
  restoreCardFromArchivedColumn,
  deleteCardPermanently,
  deleteCardFromArchivedColumn, copyCard, duplicateCard, pasteCard, pasteIntoColumn, getCopiedCard, toggleCardCompleted, setCardColor, moveCardToBoardColumn, toggleShowArchived,
  archiveSelected, copySelected, duplicateSelected, setSelectedCardsColor, setSelectedCardsPriority, toggleSelectedCardsTag, toggleSelectedCardsMember, setSelectedCardsStartDate, setSelectedCardsEndDate, moveSelectedCards,
  restoreSelected, deleteSelectedPermanently, restoreSelectedFromArchivedColumn, deleteSelectedFromArchivedColumn,
...
Object.assign(window, {
  ...
  deleteBoard,
  setColumnColor,
  deleteColumn, archiveColumn, restoreColumn, deleteColumnPermanently, copyColumn, pasteColumn, duplicateColumn, pasteColumnToBoard,
  createCard,
  saveCard,
  deleteCard,
  archiveCard,
