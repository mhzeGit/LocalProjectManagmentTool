...
export function findArchivedColumn(id) { for (const w of data.workspaces) { for (const p of w.projects) { for (const b of p.boards) { if (b.archivedColumns) { const c = b.archivedColumns.find(cl => cl.id === id); if (c) return c } } } } return null }
